/**
 * Sets the ArduinodataNode type as an object of this view
 */
View.prototype.ArduinodataNode = {};
 ...
 */
View.prototype.ArduinodataNode.commonComponents = [];
 ...
 */
View.prototype.ArduinodataNode.generatePage = function(view){
	this.view = view;
	 ...
	 * 
	 * onkeyup will fire the 'arduinodataUpdatePrompt' event which will
	 * be handled in the arduinodataEvents.js file
	 * 
	 * when you add new authoring components, you will need to create
	 * new events in the arduinodataEvents.js file and then
	 * create new functions to handle the event
	 */
	var promptTextArea = createElement(document, 'textarea', {id: 'promptTextArea', rows:'20', cols:'85', onkeyup:"eventManager.fire('arduinodataUpdatePrompt')"});
 ...
 */
View.prototype.ArduinodataNode.getCommonComponents = function() {
 ...
 */
View.prototype.ArduinodataNode.updateContent = function(){
 ...
 */
View.prototype.ArduinodataNode.populatePrompt = function() {
 ...
 */
View.prototype.ArduinodataNode.updatePrompt = function(){
	/* update content */
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/arduinodata/authorview_arduinodata.js');
};