ArduinodataNode.prototype = new Node();
ArduinodataNode.prototype.constructor = ArduinodataNode;
ArduinodataNode.prototype.parent = Node.prototype;

/*
 * the name that displays in the authoring tool when the author creates a new step
 */
ArduinodataNode.authoringToolName = "Arduinodata"; 

/*
 * will be seen by the author when they add a new step to their project to help
 * them understand what kind of step this is
 */
ArduinodataNode.authoringToolDescription = "This is a generic step only used by developers";
 ...
 * @param view
 */
function ArduinodataNode(nodeType, view) {
	this.view = view;
	this.type = nodeType;
 ...
 */
ArduinodataNode.prototype.parseDataJSONObj = function(stateJSONObj) {
	return ArduinodataState.prototype.parseDataJSONObj(stateJSONObj);
};
 ...
 */
ArduinodataNode.prototype.translateStudentWork = function(studentWork) {
	return studentWork;
};
 ...
 */
ArduinodataNode.prototype.onExit = function() {
 ...
 */
ArduinodataNode.prototype.renderGradingView = function(divId, nodeVisit, childDivIdPrefix, workgroupId) {
	//Get the latest student state object for this step
	var arduinodataState = nodeVisit.getLatestWork();
	...
	var studentWork = arduinodataState.getStudentWork();
 ...
 */
ArduinodataNode.prototype.getHTMLContentTemplate = function() {
	return createContent('node/arduinodata/arduinodata.html');
};

//Add this node to the node factory so the vle knows it exists.
NodeFactory.addNode('ArduinodataNode', ArduinodataNode);

//used to notify scriptloader that this script has finished loading
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/arduinodata/ArduinodataNode.js');
};