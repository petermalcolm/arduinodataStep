 ...
 */
function ArduinodataState(response) {
 ...
 * @return a ArduinodataState object
 */
ArduinodataState.prototype.parseDataJSONObj = function(stateJSONObj) {
 ...
 */
ArduinodataState.prototype.getStudentWork = function() {
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/arduinodata/arduinodataState.js');
}